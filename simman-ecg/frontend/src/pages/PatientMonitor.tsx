  ...
  return (
    <div className="monitor-page">
      ...
      <main className="monitor-main">
        <div className="monitor-canvas-area" style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <ECGTrack lead={lead} width={900} height={80} />
          <PlethTrack width={900} height={80} gain={34} />
          <ABPTrack width={900} height={80} />
          <PAPTrack width={900} height={80} />
          <ETCO2Track width={900} height={80} />
        </div>
